    ...
    <div class="header-landing-page bg-yellow">
        ...
        <div class="header padding-top-288" style="transition: all 0.3s ease;">
            <div class="container-main margin-bottom-178">
                ...
                <div class="font-kollektif font-size-18 width-447">Sed ut pporro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam.</div>
            </div>
        </div>
    ...
    <div class="header-landing-page bg-pink">
        ...
        <div class="header padding-top-288" style="transition: all 0.3s ease;">
            <div class="container-main margin-bottom-178">
                ...
                <div class="font-kollektif text-white font-size-18 width-447">Sed ut pporro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam.</div>
            </div>
        </div>
