    ...
    <div class="container-main">
        <div class="d-flex justify-content-between">
            ...
            <div>
                ...
                <div><a href="" class="font-size-50 font-weight-700 font-kollektif text-white text-capitalize">Our Process</a></div>
                <div><a href="" class="font-size-50 font-weight-700 font-kollektif text-white text-capitalize">Capabilities</a></div>
                <div><a href="" class="font-size-50 font-weight-700 font-kollektif text-white text-capitalize">Opportunities</a></div>
                <div><a href="" class="font-size-50 font-weight-700 font-kollektif text-white text-capitalize">Insights</a></div>
                <div><a href="" class="font-size-50 font-weight-700 font-kollektif text-white text-capitalize">Case Studies</a></div>
            </div>
        </div>
    </div>
</div>