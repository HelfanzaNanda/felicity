        ...
        <div class="d-flex justify-content-between">
            <div class="width-245">
                ...
                <div class="margin-bottom-48 d-flex align-items-center">
                    <img src="{{ asset('images/social-media/instagram-black.png') }}" width="72" height="72" class="margin-right-24">
                    <div class="font-size-24 font-weight-700">@felicity1234</div>
                </div>
                <div class="margin-bottom-48 d-flex align-items-center">
                    <img src="{{ asset('images/social-media/dribbble-black.png') }}" width="72" height="72" class="margin-right-24">
                    <div class="font-size-24 font-weight-700">@felicity1234</div>
                </div>
                <div class="margin-bottom-48 d-flex align-items-center">
                    <img src="{{ asset('images/social-media/twitter-black.png') }}" width="72" height="72" class="margin-right-24">
                    <div class="font-size-24 font-weight-700">@felicity1234</div>
                </div>
                <div class="margin-bottom-48 d-flex align-items-center">
                    <img src="{{ asset('images/social-media/youtube-black.png') }}" width="72" height="72" class="margin-right-24">
                    <div class="font-size-24 font-weight-700">@felicity1234</div>
                </div>
            </div>
            <div class="width-426">
